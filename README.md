...
![img.png](img_data/lab7/lab8/img.png)
...
![img_8.png](img_data/lab7/lab8/img_8.png)
...
![img_9.png](img_data/lab7/lab8/img_9.png)
...
![img_10.png](img_data/lab7/lab8/img_10.png)
...
![img.png](img_data/lb8/sum.png)

read_file.sh

![img.png](img_data/lb8/read_file.png)

replace_text.sh

![img.png](img_data/lb8/replace_text.png)

backup.sh

![img.png](img_data/lb8/backup.png)

math_operations.sh

![img.png](img_data/lb8/math_operations.png)
...
![img.png](img_data/lb9/install_ubuntu.png)

Установка openssh_server на ubuntu 

![img.png](img_data/lb9/openssh_server.png)

Настройка пользователя и пароля и изменения конфига ssh

![img.png](img_data/lb9/username_pass.png)

![img.png](img_data/lb9/ssh_config.png)

Запуск ssh сервера

![img.png](img_data/lb9/run_ssh.png)

2

Подключаемся по ssh к контейнеру

![img.png](img_data/lb9/connection.png)

3

Создаем локально файл и файл в контенере

![img.png](img_data/lb9/local_file.png)

Выполняем копирование при помощи scp с компьютера на ubuntu в контейнер

![img.png](img_data/lb9/from_pc_to_server.png)

Результат копирования

![img.png](img_data/lb9/resault1.png)
